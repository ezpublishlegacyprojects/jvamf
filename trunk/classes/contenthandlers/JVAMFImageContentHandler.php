...
class JVAMFImageContentHandler implements IJVAMFContentHandler
{
	public static function handleContent(eZContentObjectAttribute $attr)
	{
		$imageArray = array();
		$amfINI = eZINI::instance('jvamf.ini');
		$imageSizes = $amfINI->variable('ImageSettings', 'ReturnedImageSizes');
